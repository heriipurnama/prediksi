...
function tambahUser($id_user, $username, $password, $level){
  $koneksi = koneksi();
  $sql = "insert into user values('$id_user', '$username', '$password', '$level')";
  $hasil = 0;
...
function ubahUser($id_user, $username, $password, $level){
  $koneksi = koneksi();
  $sql = "UPDATE user
